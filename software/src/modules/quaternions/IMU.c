...
t_fp_vector EstG;
// Normalize a vector
void normalizeV(struct vector3_t *src, struct vector3_t *dest)
{
	float length;
...
void rotateV(struct vector3_t *v, float *delta)
{
	struct vector3_t v_tmp = *v;
