...
//====================================================================================================
// Functions
void MahonyUpdatePars(void);
void MahonyUpdatePars(void)
{
	twoKp = (float)myPar.P_mahony.sValue * 0.01 * 2.0;
	twoKi = (float)myPar.I_mahony.sValue * 0.01 * 2.0;
}
...
quaternion_t MahonyAHRSupdate(float gy, float gx, float gz, float ay, float ax, float az, float my, float mx, float mz) {
	quaternion_t ret;
	float recipNorm;
