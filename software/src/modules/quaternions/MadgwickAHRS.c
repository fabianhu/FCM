...
//====================================================================================================
// Functions
void MadgwickUpdateBeta(void);
void MadgwickUpdateBeta(void)
{
	beta = (float)myPar.a_madg.sValue * 0.01;
}
...
bool MadgwickStart(void) // cyclic call every 10ms until returns true.
{
	...
	else
	{
		...
		// wait for Madgwick
		// remember actual height (maybe filtered)
		return false;
	}
}
...
quaternion_t MadgwickAHRSupdate(float gy, float gx, float gz, float ay, float ax, float az, float my, float mx, float mz) {
	...
	// Rate of change of quaternion from gyroscope // just add gyro difference
